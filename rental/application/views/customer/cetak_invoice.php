        ...
        <div class="boarding-pass">
            <header>
                ...
                <div class="flight">
                    ...
                    <strong><?php echo $tr->no_plat ?></strong>
                </div>
            </header>
            <section class="cities">
                <div class="city">
                    <strong>Pemilik</strong>
                    <small>FLASHFAST Coorporate</small>
                </div>
                <div class="city">
                    <strong>User</strong>
                    <small><?php echo $tr->nama ?></small>
                </div>
                <svg class="airplane">
            ...
            <section class="infos">
                <div class="places">
                    <div class="box">
                        ...
                        <strong><em><?php echo $tr->merk ?></em></strong>
                    </div>
                    <div class="box">
                        <small>Warna</small>
                        <strong><em><?php echo $tr->warna ?></em></strong>
                    </div>
                </div>
                <div class="times">
                    <div class="box">
                        <small>Tahun</small>
                        <strong><?php echo $tr->tahun ?></strong>
                    </div>
                    <div class="box">
                        <small>Harga</small>
                        <strong><?php echo number_format($tr->harga + $tr->harga_paket) ?></strong>
                    </div>
                </div>
            </section>
            <section class="strap">
                <div class="box">
                    <div class="passenger">
                        <small>Teknis Rental</small>
                        <strong>
                            <font color="green"><?php echo $tr->opsi ?></font>
                        </strong>
                    </div>
                    <div class="passenger">
                        <small>Status Rental</small>
                        <strong>
                            <font color="green"><?php echo $tr->status_rental ?></font>
                        </strong>
                    </div>
                    <div class="passenger">
                        <small>Estimasi</small>
                        <strong><?php echo date('d M Y', strtotime($tr->tanggal_rental));  ?> - <?php echo date('d M Y', strtotime($tr->tanggal_kembali));  ?></strong>
                    </div>
                </div>
                <svg class="qrcode">
