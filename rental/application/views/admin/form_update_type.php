                            ...
                            <form method="POST" action="<?php echo base_url('admin/data_type/update_type_aksi') ?>">
                                <div class="form-row">
                                    <div class="form-group col-md-6">
                                        ...
                                        <input type="text" name="kode_type" autocomplete="off" class="form-control" value="<?php echo $tp->kode_type ?>">
                                        <?php echo form_error('kode_type', '<div class="text-small text-danger">', '</div') ?>
                                    </div>
                                    <div class="form-group col-md-6">
                                        <label>Nama Type</label>
                                        <input type="text" name="nama_type" autocomplete="off" class="form-control" value="<?php echo $tp->nama_type ?>">
