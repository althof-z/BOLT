        ...
        <div class="row">
            <div class="col-md-12 mb-1">
                <div class="alert border-0 alert-primary bg-gradient alert-dismissible fade show border-radius-none" role="alert">
                    Silahkan ubah kendaraan dengan lengkap dan benar.
            ...
            <div class="col-xxl-6 m-b-30">
                <div class="card card-statistics h-100 mb-0">
                    <div class="card-header">
                        <h4 class="card-title text-purple">Ubah Kendaraan</h4>
                    </div>
                    <div class="card-body">
                            ...
                            <form method="POST" action="<?php echo base_url('admin/data_mobil/update_mobil_aksi') ?>" enctype="multipart/form-data">
                                <div class="form-row">
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input type="text" name="merk" autocomplete="off" class="form-control" value="<?php echo $mb->merk ?>" required="">
                                        <?php echo form_error('merk', '<div class="text-small text-danger">', '</div') ?>
                                    </div>
                                    <div class="form-group col-md-6">
                                        <label>Teknis Rental</label>
                                        <select name="opsi" class="form-control">
                                            <option value="<?php echo $mb->opsi ?>"><?php echo $mb->opsi ?></option>
                                    ...
                                    <div class="form-group col-md-6">
                                        <label>No. Plat</label>
                                        <input type="text" name="no_plat" autocomplete="off" class="form-control" value="<?php echo $mb->no_plat ?>" required="">
                                        <?php echo form_error('no_plat', '<div class="text-small text-danger">', '</div') ?>
                                    </div>
                                    <div class="form-group col-md-6">
                                        <label>Warna</label>
                                        <input type="text" name="warna" autocomplete="off" class="form-control" value="<?php echo $mb->warna ?>" required="">
                                        <?php echo form_error('warna', '<div class="text-small text-danger">', '</div') ?>
                                    </div>
                                    <div class="form-group col-md-6">
                                        <label>Harga Sewa /Hari</label>
                                        <input type="number" name="harga" autocomplete="off" class="form-control" value="<?php echo $mb->harga ?>" required="">
                                        <?php echo form_error('harga', '<div class="text-small text-danger">', '</div') ?>
                                    </div>
                                    <div class="form-group col-md-6">
                                        <label>Denda</label>
                                        <input type="number" name="denda" autocomplete="off" class="form-control" value="<?php echo $mb->denda ?>">
                                    </div>
                                    <div class="form-group col-md-6">
                                        <label>Tahun Keluaran</label>
                                        <input type="text" name="tahun" autocomplete="off" class="form-control" value="<?php echo $mb->tahun ?>" required="">
