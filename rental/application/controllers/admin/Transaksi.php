...
class Transaksi extends CI_Controller
{
    ...
    {
        $data['transaksi'] = $this->db->query("SELECT transaksi.*, mobil.*, customer.*, wisata.nama as nama_wisata, wisata.harga as harga_paket
        FROM transaksi
    ...
    public function transaksi_selesai_aksi()
    {
        ...
        $this->rental_model->update_data('transaksi', $data, $where);
        $this->session->set_flashdata('berhasil', 'Pesanan pelanggan telah selesai');
        redirect('admin/transaksi');
    }
    ...
    public function batal_transaksi($id)
    {
        ...
        $this->session->set_flashdata('berhasil', 'Pesanan pelanggan berhasil di batalkan');
        redirect('admin/transaksi');
    }
}
